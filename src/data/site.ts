...
export const MILESTONES = [
  ...
  { year: "2022", title: "Lancement E-MA2E", desc: "Plateforme digitale pour les sociétaires." },
];
...
export type NewsArticle = {
  ...
  readTime?: string;
  tags?: string[];
  content: { type: "p" | "h2" | "quote" | "list" | "gallery" | "image"; text?: string; items?: string[] }[];
};
...
export const FAQ_IMMO = [
  { q: "Qui peut bénéficier du programme immobilier ?", a: "Tout sociétaire MA2E à jour de ses cotisations et justifiant d'une ancienneté minimale de 24 mois." },
