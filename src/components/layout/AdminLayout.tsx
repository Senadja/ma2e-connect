...
export const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { to: "/admin/products", icon: Briefcase, label: "Produits & Offres" },
    { to: "/admin/applications", icon: FileText, label: "Demandes & Formulaires" },
  ...
  return (
    <div className="min-h-screen bg-secondary/20 flex">
      ...
      <aside 
        className={cn(
          "hidden md:flex flex-col border-r border-border bg-card transition-all duration-300 z-30",
          collapsed ? "w-20" : "w-64"
        )}
      >
