...
export const NEWS = [
  {
    ...
    excerpt: "La MA2E convie tous ses sociétaires à l'AG annuelle pour présenter les résultats et perspectives.",
  ...
  },
  {
    ...
    excerpt: 'Ouverture officielle de notre 3ème agence pour mieux servir nos sociétaires de l\'intérieur.',
    ...
    content: [
      ...
      { type: 'h2', text: 'Une réponse aux attentes des sociétaires' },
      { type: 'p', text: "Avec plus de 1 200 sociétaires recensés dans la région du Bélier, l'ouverture de cette agence répond à un besoin exprimé de longue date. Les sociétaires pourront désormais effectuer toutes leurs opérations courantes sans avoir à se déplacer à Abidjan." },
  ...
  },
  {
    ...
    readTime: '5 min',
    content: [
      { type: 'p', text: 'Pour célébrer le succès de notre programme immobilier et accompagner toujours plus de sociétaires vers la propriété, la MA2E lance une offre exceptionnelle sur les crédits immobiliers signés entre le 15 janvier et le 30 juin 2025.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: 'Douze sociétaires ont reçu officiellement les clés de leur nouveau logement, fruit de plusieurs années d\'épargne et d\'un accompagnement personnalisé par les équipes de la mutuelle.' },
  ...
  },
  {
    ...
    excerpt: 'Nouvelle interface, espace sociétaire enrichi et notifications en temps réel.',
    ...
    content: [
      ...
      { type: 'list', items: ['Nouvelle interface plus claire et accessible', 'Tableau de bord personnalisé par profil de sociétaire', 'Notifications en temps réel (SMS et push)', 'Téléchargement instantané des relevés et attestations', 'Simulateur de crédit et d\'épargne intégré'] },
...
export const CREDITS = [
  { id: 'ordinaire', name: 'Crédit Ordinaire', duree: 'Jusqu\'à 60 mois', taux: '8% / an', montant: 'Jusqu\'à 30 M FCFA', conditions: 'Sociétaire depuis 6 mois', image: '/images/products/Fiche_Produit_CREDIT ORDINAIRE.jpg', form: '/documents/formulaires/Formulaire_DEMANDE DE CREDIT ORDINAIRE 2026.docx' },
...
export const FAQS = [
  { category: 'Adhésion', question: 'Qui peut devenir sociétaire de la MA2E ?', answer: "Tout agent en activité des sociétés du secteur de l'eau et de l'électricité (CIE, SODECI, et structures affiliées) peut devenir sociétaire." },
  ...
  { category: 'Crédit', question: 'Quelles sont les conditions pour obtenir un crédit ?', answer: 'Être sociétaire depuis au moins 6 mois, être à jour de ses cotisations et présenter un dossier complet (justificatifs de revenus, projet, garanties).' },
  ...
  { category: 'E-MA2E', question: 'Qu\'est-ce que la plateforme E-MA2E ?', answer: 'E-MA2E est l\'espace digital permettant aux sociétaires de consulter leur compte, télécharger leurs relevés et effectuer des opérations en ligne.' },
...
export const SETTINGS_DEFAULTS: Record<string, unknown> = {
  ...
  // Reproduit l'organigramme officiel MA2E (MAJ 22/05/2026), postes opérationnels inclus.
  orgTree: {
